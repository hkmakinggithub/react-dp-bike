...
const ClientMaster = () => {
  ...
  const fetchModels = async () => {
    try {
      ...
      const res = await fetch(`${import.meta.env.VITE_BACK}/api/models`, {
        headers: { 
          'branch-id': activeBranch,
          'Authorization': `Bearer ${token}` 
        } 
  ...
  const fetchCustomers = async () => {
    try {
      ...
      const res = await fetch(`${import.meta.env.VITE_BACK}/api/customers-list`, {
        headers: { 
          'branch-id': activeBranch,
          'Authorization': `Bearer ${token}` 
        } 
  ...
  const handleAddModel = async () => {
    ...
    try {
      const token = localStorage.getItem('token');
      const res = await fetch(`${import.meta.env.VITE_BACK}/api/add-model`, {
        method: 'POST',
        headers: { 
  ...
  const handleAddCustomer = async () => {
    ...
    try {
      const token = localStorage.getItem('token');
      const res = await fetch(`${import.meta.env.VITE_BACK}/api/add-customer`, {
        method: 'POST',
        headers: { 
            'Content-Type': 'application/json',
            'branch-id': activeBranch,
  ...
  const handleSaveSale = async () => {
    ...
    try {
      ...
      const res = await fetch(`${import.meta.env.VITE_BACK}/api/save-sale`, {
        method: 'POST',
        headers: { 
          'Content-Type': 'application/json', 
          'branch-id': activeBranch,
